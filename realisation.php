...
<head>
    ...
    <title>Virtual project || Réalisation</title>
...
<body>
    ...
    <div class="wrapper">
	   ...
	   <!-- Start Bradcaump area -->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">NOS REALISATIONS</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="#">Accueil</a>
                                  <span class="brd-separetor">-</span>
                                  <span class="breadcrumb-item active">NOS REALISATIONS</span>
                                </nav>
                            </div>
                        </div>
                    </div>
        ...
        <div class="htc__latest__project__area pb--150 bg__white">
            <div class="container">
                <div class="row">
                                        ...
                                        <div class="project__thumb">
                                            ...
                                            <div class="project__hover__info">
                                               <div class="project__action">
                                                    <h2>Rénovation de la ville</h2>
                                                    <h4><a href="#">Voir le projet</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
